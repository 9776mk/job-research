...
- 제휴 마케팅 플랫폼 프론트엔드 개발
- 빅데이터 플랫폼 프론트엔드 개발
- 데이터 비쥬얼라이징 작업(표, 차트 등)
- 비즈니스로직을 고려한 UI/UX 개선
#### 요구사항
- Vuejs나 Reactjs 프론트엔드 경력 1년 이상
- 퍼블리싱 경력 1~2년 이상
- Git 사용능력 갖춘 분
- 웹개발 기본소양 갖춘 분
...
- 웹 서비스 프론트엔드 개발
- AI 퍼스널 트레이너 서비스 개발
- 안정적이고 효율적인 프론트엔드 개발을 위한 프레임워크 고도화 
- 서비스 유지 및 보수
#### 요구사항
- 프론트엔드 개발 2년 이상의 경력 혹은 그에 상응하는 실력을 갖추신 분
- ReactJS/ JavaScript/ TypeScript/ CSS/ HTML에 대한 깊은 실무 지식과 최신 스펙에 대한 경험, 완성도 높은 결과물 구현능력
- 능동적인 업무 수행과 협업을 중요하게 생각하시는 분
- 팀원을 존중하고 배려할 줄 아는 마음을 가지신 분
#### 우대사항
- Alyce가 운동 영상을 주로 다루는 프로그램이기 때문에 영상 관련 프로그래밍을 해보셨던 분
- CI/CD 구축 경험이 있으신 분
- TDD(Test Driven Development)를 적용해 보신 분
- 업무 협업을 위한 Tool 사용에 익숙하신 분 (Git, Slack, Zeplin, Jira, Confluence 등)
...
- 학생의 예약 프로세스 구현
- 튜터의 주간 클래스 스케줄러 구현
- 튜터와 학생의 화상 수업 서비스 구현
- i’mport 기반의 결제 시스템 연동
#### 요구사항
- 2년 이상의 모던 웹 개발(React, Next.js 등) 경험 혹은 이에 준하는 역량을 갖춘 분
- 반응형 웹 개발에 대한 이해가 있으신분
- 문제 해결을 위해 주도적으로 생각하고 행동하시는 분
- 사내 업무 시스템 사용에 어려움이 없으신 분 - Git, Slack, Notion etc
- 2022년 7월 이후부터 근무 가능하신 분(입사일 협의 가능)
#### 우대사항
- 상용 웹 서비스 개발 경험
- 프론트엔드 개발팀 리드 경험
